...
const NAV_ITEMS = [
  ...
  { label: "Messages", icon: "mail", href: "/recruiter/messages", color: "#3b82f6" },
];
            ...
            <div className="absolute top-[calc(100%+8px)] left-0 w-full bg-white border border-[#cfc4c5] shadow-xl rounded-xl p-3 z-[100] animate-fade-rise">
              <div className="flex items-center gap-3">
                ...
                <p className="font-[Inter] text-[12px] text-[#4c4546]">
                  {searchValue ? `Searching across the platform for "${searchValue}"...` : "Type to search candidates, jobs, and messages..."}
                </p>
              </div>
            </div>
          )}
